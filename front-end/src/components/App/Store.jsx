...
export const Store = ({ storeData,viewUser }) => {
  ...
  return (
    <div className="bg-dark mx-auto my-3.5 px-3 py-2 rounded-md w-[100%] mb-2 cursor-pointer lg:mb-0 lg:w-[48%] hover:bg-black duration-200" onClick={() => navigate(`/store/${storeData.id}`)}>
