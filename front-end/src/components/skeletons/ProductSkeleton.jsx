export const ProductSkeleton = () => {
  return (
    <div
      role="status"
      className="w-full p-4 border border-gray-200 rounded shadow animate-pulse md:p-6 dark:border-gray-500"
    >
      <div
        role="status"
      ...
      >
        ...
        <div className="w-full">
          <div className="flex items-center">
            <svg
              className="w-8 h-8 text-gray-200 dark:text-gray-500"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 20 20"
          ...
          <div className="mt-5">
            ...
            <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-500 max-w-[100%] mb-2.5"></div>
            ...
            <div className="h-3 bg-gray-200 rounded-full dark:bg-gray-500 max-w-[150px] mb-2.5"></div>
            <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-500 max-w-[200px] mb-2.5"></div>
            <div className="h-2 bg-gray-200 rounded-full dark:bg-gray-500 max-w-[140px] mb-2.5"></div>
            <div className="h-6 bg-gray-200 rounded-full dark:bg-gray-500 max-w-[80px] mt-2 mb-2.5"></div>
          </div>
        </div>
      </div>
    </div>
