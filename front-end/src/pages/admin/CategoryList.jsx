...
import { addNewCategory, deleteCategoryService, getCategoryList } from "../../services/categoryServices";
...
export const CategoryList = () => {
    ...
    const handleSubmit = async (e) =>{
        ...
        setAddLoading(true);
        try{
            const response = await addNewCategory(localStorage.getItem('token'),formdata);
            setAddLoading(false);
    ...
    const deleteCategory = async (categoryId) => {
        ...
        try{
            const response = await deleteCategoryService(localStorage.getItem("token"),categoryId)
      ...
      <div>
        ...
        <div className="lg:ml-[21%] px-2">
            ...
            <div className="w-[30%] mt-5">
                <Button text={"Add category"} width={"40%"} onClick={() => setOpenAjoute(true)}/>
            </div>
            ...
            {openAjoute && (
                <AddCategory loading={addLoading} handleSubmit={handleSubmit} handleChange={handleChange} setOpenAjoute={setOpenAjoute} />
            )
