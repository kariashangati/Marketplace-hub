      ...
      <div className="lg:ml-[21%] px-2">
        ...
        <div>
                    ...
                    ? stores.map((_storeData) => {
                        return (
                          <Store
                            ...
                            setupdateOpen={setOpenUpdateStore}
          ...
          {openUpdateStore && (
            <UpdateStore
              storeData={storeData}
              handleUpdateStoreSubmit={handleUpdateStoreSubmit}
              setOpenUpdateStore={setOpenUpdateStore}
              handleUpdateStoreChange={handleStoreChange}
              updateStoreLoading={updateStoreLoading}
            />
          )}
        </div>
      </div>
